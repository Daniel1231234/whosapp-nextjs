    ...
    <>
      <section className="flex min-h-screen items-stretch">
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
          <div className="absolute lg:hidden z-10 inset-0 bg-slate-800 bg-no-repeat bg-cover items-center">
            <div className="absolute bg-slate-800 opacity-60 inset-0 z-0"></div>
          </div>
          {isSign ? (
            <LoginForm
